...
//               >
//                 <Link to={offer.link}>
//                   <div className="group block overflow-hidden bg-white shadow-sm border border-gray-200/80 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">

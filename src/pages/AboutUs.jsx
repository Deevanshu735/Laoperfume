...
import heroImage from "../assets/Hl3.jpg";
import storyImage from "../assets/CI1.jpeg";
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            The Essence of <span className="text-brand-gold">Laoperfume</span>
          </motion.h1>
        </div>
      </div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        {/* --- 2. Engaging "Our Story" Layout --- */}
        <motion.section
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Founded on the principles of passion and artistry, Laoperfume
              began as a dream to capture fleeting moments and transform them
              into timeless scents. We believe that a fragrance is more than
              just a product; it's a personal signature.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mt-4">
              Our journey started in a small workshop in Vientiane, where we
              meticulously blended rare ingredients to create perfumes that
              evoke emotion and inspire confidence.
            </p>
          </motion.div>
        </motion.section>

        {/* --- 3. Refined "Values" Cards --- */}
        <motion.section
          variants={sectionVariants}
          initial="hidden"
          whileInView="visible"
        ...
        >
          {values.map((value, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="bg-white p-8 rounded-lg border border-gray-200/80 shadow-sm text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                variants={itemVariants}
              >
      ...
      {/* --- 4. Impactful Call to Action Section --- */}
